 ...
 * ou au cours de la creation d'un objet de la famille 
 * des SelectableFile, le fichier source fourni de type File
 * ne correpond pas aux exigences de classe de l'objet. 
 * 
 * Auteurs du projet :
 * 

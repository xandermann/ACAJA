...
public final class UnfindableResourceException extends Exception {
	...
	public final static String UAITR_CONVERSION_IMPORTS = UAITR_PREFIX + "des imports pour la conversion"
			+ UAITR_SUFFIX;
	public final static String UAITR_PROCESSING_IMPORTS = UAITR_PREFIX + "des imports pour le traitement"
			+ UAITR_SUFFIX;

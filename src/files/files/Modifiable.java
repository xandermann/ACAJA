 ...
 * 
 * Ces methodes ont un comportement en interne different selon si on est dans la
 * classe SettingsFile ou dans la classe ProcessingFile.
 * 
 * En effet selon la classe, modifier a un sens different. Cela justifie la
 * declaration l'existence de cette interface.
 * 
 * Auteurs du projet :
 * 
...
public interface Modifiable {
	 ...
	 * 
	 * Methode dont le comportement en interne change selon si on est dans la classe
	 * SettingsFile ou dans la classe ProcessingFile.
	 * 
	 * En effet selon la classe, modifier a un sens different. Cela justifie la
	 * declaration l'existence de cette interface.
	 * 
	 ...
	 * SettingsFile ou dans la classe ProcessingFile.
	 * 
	 * En effet selon la classe, etre modifiee a un sens different. Cela justifie la
	 * declaration l'existence de cette interface.
	 * 

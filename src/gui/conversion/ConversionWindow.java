...
public final class ConversionWindow extends StylizedJFrame {
	...
	private JMenu drawConvertMenu() {
		...
		convertItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				waitWindow.add(
						new JLabel("<html>" + "<body>" + "		Conversion du ou des fichier(s)." + "		<br>   "
								+ "		Veuillez patientez..." + "</body>" + "</html>", JLabel.CENTER),
						BorderLayout.CENTER);
	...
	/**
	 * [ METHODE DE CLASSE DE CONSTRUCTION ET DE GENERATION DE LA FENETRE DE
	 * CONVERSION. ]
	 */

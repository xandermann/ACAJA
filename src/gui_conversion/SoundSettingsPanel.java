...
public class SoundSettingsPanel extends JPanel implements Observer {
	...
	public void update(Observable o, Object arg) {
		if (model.getCurrentFile() != null) {
			...
			includeBitrate.setText("" + (Integer) settings.get(SettingsFile.AUDIO_BITRATE));
			includeBitrate.setEnabled(true);
			includeSamplingRate.setText("" + (Integer) settings.get(SettingsFile.SAMPLING_RATE));
			includeSamplingRate.setEnabled(true);
			includeChannels.setText("" + (Integer) settings.get(SettingsFile.NUMBER_AUDIO_CHANNELS));

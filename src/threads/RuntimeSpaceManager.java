...
public final class RuntimeSpaceManager {
	 ...
	 * 
	 * Ce gestionnaire possede une main, qu'on peut prendre et rendre depuis
	 * l'interieur comme depuis l'exterieur de la classe. Une main est un genre de
	 * verrou, pris en compte par tous les processus du fil d'execution du logiciel.
	 */

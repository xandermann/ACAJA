...
public final class ResolutionsConstants {
	...
	private static String[] getAllResolutions() {
		ArrayList<String> allResolutions = (ArrayList<String>) Arrays.asList(CIF_RESOLUTIONS); 
		...
		return (String[]) allResolutions.toArray();
	}
}
